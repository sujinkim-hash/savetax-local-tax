...
export default function Home() {
  ...
  return <main className="appShell">
    ...
    <div className="appContent">
      <header className="topBanner"><div><p className="eyebrow">LOCAL INCOME TAX DIRECTORY</p><h1>전국 지방소득세 담당자 연락처</h1><p className="lead">종합소득세와 관련된 담당 주무관 기준으로 전국 시·군·구 연락처를 한 곳에서 확인합니다.</p></div><div className="headerActions"><Link className="reviewLink" href="/review">검토 현황</Link><button type="button" className="admin" onClick={() => setAdminDialogOpen(true)}>관리자 인증</button></div></header>
