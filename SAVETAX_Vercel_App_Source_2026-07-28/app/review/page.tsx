...
export default function ReviewPage() {
  ...
  const registeredReviews = reviews.filter((review) => review.field === "공식 주소" ? review.proposed_value === "등록" : review.proposed_value !== "미등록");
  const unregisteredReviews = reviews.filter((review) => review.field === "공식 주소" && review.proposed_value === "미등록");
